...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_9|GPIO_PIN_10|RCLK_Pin|GPIO_PIN_12, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PC9 PC10 PCPin PC12 */
  GPIO_InitStruct.Pin = GPIO_PIN_9|GPIO_PIN_10|RCLK_Pin|GPIO_PIN_12;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
